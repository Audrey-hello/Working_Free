...
user_2 = User.create!(email: 'user_2@gmail.com', password: '456789')
  ...
  offices = [{ address: '14 rue Crespin du Gast', title: 'Le Wagon', price: '25€', description: '60 workstations in openspace', user: user_1, capacity: 60},{ address: '16 villa gaudelet, 75011 Paris', title: 'Le Perchoir', price: '25€', description: '90 workstations in openspace', user: user_1, capacity: 90},{ address: '64-66 rue des archives, 75003 Paris', title: 'Wework marais', price: '40€', description: '150 workstations in openspace', user: user_2, capacity: 150},{ address: '5 tour saint jacques, 75005 Paris', title: 'OpenSpace', price: '35€', description: '60 workstations in openspace', user: user_2, capacity: 60},{ address: 'Rue du Cloître Saint-Merri, 75004 Paris', title: 'FlexWork', price: '19€', description: '20 workstations in openspace', user: user_2, capacity: 20}]
