...
user_1 = User.new(email: "user_1@gmail.com", password: "123456")
user_1.save!
file = URI.open("https://res.cloudinary.com/dgck8cniu/image/upload/v1624109574/DSC03556_2_fm0opl.jpg")
user_1.photo.attach(io: file, filename: "#{user_1.email}.jpg", content_type: 'image/jpg')

user_2 = User.new(email: "user_2@gmail.com", password: "123456")
user_2.save!
file = URI.open("https://res.cloudinary.com/dgck8cniu/image/upload/v1624109574/DSC03556_2_fm0opl.jpg")
user_2.photo.attach(io: file, filename: "#{user_2.email}.jpg", content_type: 'image/jpg')

user_3 = User.new(email: "user_3@gmail.com", password: "123456")
user_3.save!
file = URI.open("https://res.cloudinary.com/dgck8cniu/image/upload/v1624109574/DSC03556_2_fm0opl.jpg")
user_3.photo.attach(io: file, filename: "#{user_3.email}.jpg", content_type: 'image/jpg')




# users.each_with_index do |photo, index|
#     file = URI.open(photo_user[index])
#     user_photo = User.create!(photo)
#     user_photo.photo.attach(io: file, filename: "#{user.email}.jpg", content_type: 'image/jpg')
# end
